...
public class SAPController {
	...
	public ResponseEntity<Object> getXMLFromSAP(@RequestBody Object temporaryModel) throws JSONException, JsonProcessingException {
		...
		xml.setDocumentid(xmlJSONObj.getJSONObject("Body").getJSONObject("Document").getJSONObject("BusinessDocument").getJSONObject("PurchaseOrderHeader").getString("DocumentID"));
	...
	public ResponseEntity<TemporaryModel> getTemporaryData(@PathVariable("documentId") Long documentId)
			throws JSONException {
		...
		//String response2 = response.toString();
		TemporaryModel getxmlDetails = temporaryService.getxmlDetails(documentId);

		return new ResponseEntity<>(getxmlDetails, HttpStatus.OK);
	}
	
	/*
	 * public static void main(String[] args) { try { JSONObject xmlJSONObj = XML.
